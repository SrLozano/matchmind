...
Matchmind uses Stripe Checkout for the one-time World Cup Tournament Pass: €9.99 normally, or €8.99 when the user has applied a referral code. Keep all Stripe values in the root/backend `.env` and use test-mode keys only during development:
