...
export const translations = {
  en: {
    ...
    profile: {
      ...
      fairUseChats: "Premium includes a generous weekly fair-use limit.",
      noDailyCap: "Fair-use quota resets weekly while Premium is active.",
      ...
      upgradeCopy: "Get 200 coach chats per week, full market signals, and value checks from group stage to the final. One payment, no subscription.",
  ...
  es: {
    ...
    profile: {
      ...
      fairUseChats: "Premium incluye un límite semanal generoso de uso justo.",
      noDailyCap: "La cuota de uso justo se reinicia semanalmente con Premium activo.",
      ...
      upgradeCopy: "Consigue 200 chats semanales con el coach, señales completas de mercado y checks de valor desde la fase de grupos hasta la final. Un pago, sin suscripción.",
      ...
      features: [
        "200 chats IA con el coach por semana",
