...
export const translations = {
  en: {
    ...
    feed: {
      ...
      lockedCopy: "Unlock the pick, confidence score, Polymarket edge, and coach take.",
      locked: "Locked",
    ...
    chat: {
      ...
      noMarketSignal: "No useful Polymarket signal was found for this bet.",
    ...
    profile: {
      ...
      features: [
        ...
        "Full Polymarket divergence feed",
  ...
  es: {
    ...
    feed: {
      ...
      lockedCopy: "Desbloquea el pick, la confianza, el edge de Polymarket y la lectura del coach.",
      locked: "Bloqueado",
    ...
    chat: {
      ...
      noMarketSignal: "No se encontró una señal útil de Polymarket para esta apuesta.",
    ...
    profile: {
      ...
      features: [
        ...
        "Feed completo de divergencias Polymarket",
